...
Possible Reason: More points sampled means there is less source points so the result become bad, not because the linear solve has infinite solutions to choose from. 