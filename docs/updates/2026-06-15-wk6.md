...
### Right now, chunking across the m dimension is causing problems (M_nodes = 20000 will OOM), because the featureextracter network is fully connected. Will look into this...