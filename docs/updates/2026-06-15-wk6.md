...
Each iteration takes much longer compared to without checkpointing.
...
**sketch-and-project_v1** Unroll of lax.scan causes error:
E0619 17:02:15.180195 486093 gpu_hlo_schedule.cc:946 The byte size of input/output arguments (7372800000) exceeds the base limit (6871528243).
...
**Still checking the logic for the memory saving method, not sure if it is working as intended... also, the sketch-and-project accuracy was bad after changing to 8 samples 8 linear weights for N=1500 and M=1024 , tuning the hyperparameters...**
...
Epoch 001 | Train Loss: 1.4869e+01 | Val MSE: 1.9916e-08 | TikReg: 1.03e-05
